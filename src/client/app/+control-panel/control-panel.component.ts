...
export class ControlPanelComponent {
  ...
  onGenerate() {
    this.matrixGeneratorService.generateMatrix(null);
  }
  ...
  onSaveMatrix() {
    this.databaseService.updateRegressionMatrix(
      this.matrixGeneratorService.matrixTests,
      new Date().toLocaleString(),
      this.sessionService.session.selectedProductRelease.ProductReleaseVersion
    );
  }
