...
export class SeedConfig {
   ...
   * The default port is `5556`, which can be overriden by the  `--port` flag
   ...
   * @type {string}
   */
  APP_BASE = argv['base'] || '/RegressionMatrixGenerator/';
  ...
  /**
   * The path to output files for injection in prod build
   */
  PROD_PATH = '../../../../RegressionMatrixGenerator/dist/prod/';
  ...
  APP_ASSETS: InjectableDependency[] = [
    { src: `${this.CSS_SRC}/gui.css`, inject: true, vendor: false },
    { src: `${this.CSS_SRC}/basic.css`, inject: true, vendor: false },
    { src: `${this.CSS_SRC}/dev.css`, inject: true, vendor: false },
    { src: `${this.CSS_SRC}/thirdParty/ag-grid.css`, inject: true, vendor: false},
    { src: `${this.CSS_SRC}/thirdParty/theme-fresh.css`, inject: true, vendor: false}
  ];
